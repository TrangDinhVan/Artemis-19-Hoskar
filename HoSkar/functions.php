...
function load_more_posts() {
    ...
    if ($query->have_posts()) :
        while ($query->have_posts()) : $query->the_post();
            $posts_html .= '<a class="gallery-item" href="' . get_the_post_thumbnail_url(get_the_ID(), 'full') . '" target="_blank" data-fancybox="mygallery" data-caption="' . get_the_title() . '" title="' . get_the_title() . '">';
            $posts_html .= '<img src="' . get_the_post_thumbnail_url(get_the_ID(), 'full') . '" alt="' . get_the_title() . '" />';
            $posts_html .= '</a>';
        endwhile;
