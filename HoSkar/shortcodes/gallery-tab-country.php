                            ...
                            if (have_rows('tab_gallery2')) {
                                ...
                                <div id="tab-0" class="tab-content tab-bar-content <?php if (get_sub_field('title2') =='Networking') echo 'is-active'; ?> <?php echo get_sub_field('title2'); ?>" <?php if (get_sub_field('title2') != 'Networking') echo 'style="display:none;"'; ?>>
                                    ...
                                    <div class="see-more-container" <?php if ($total_images <= 9) echo 'style="display:none;"'; ?>>
                                        <button class="see-more" data-first-images='<?php echo json_encode($first_images); ?>' data-category-id="0" data-location-id="<?php echo get_sub_field('title2'); ?>" data-title_location="<?php echo sanitize_title(get_sub_field('title2')); ?>" data-title-id="<?php echo sanitize_title(get_sub_field('title2')); ?>" >See All</button>
                                    </div>
                                ...
                                if (isset($location['title_location2'])) {
                                    ...
                                    if (isset($location['image2']) && is_array($location['image2'])) {
                                        ...
                                        foreach ($location['image2'] as $image) {  
                                         ...
                                         <div class="see-more-container" <?php if ($total_images <= 9) echo 'style="display:none;"'; ?>>
                                            <button class="see-more" data-first-images='<?php echo json_encode($first_images); ?>' data-category-id="<?php echo sanitize_title($title_location); ?>" data-title_location="<?php echo sanitize_title($title_location)?>-<?php echo $title_location_count[$title_location]; ?>" data-location-id="<?php echo $gallery['title2']; ?>" data-title-id="<?php echo sanitize_title($title_location); ?>">See All</button>
                                        </div>
                                    </div>
                                <?php
                                }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.see-more').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            var first_images = this.getAttribute('data-first-images');
            var data = {
