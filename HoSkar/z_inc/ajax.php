...
function z_do_ajax() {
    ...
    if( $_action == 'submitReg' ):
        ...
        <p>Location company: <strong><?php echo 'Dữ liệu chưa xử lý'; ?></strong></p>
        <p>Category: <strong><?php echo 'category chưa xử lý'; ?></strong></p>
        ...
        <p>Detail: <strong><?php echo $d['detail']; ?></strong></p>
        <?php
